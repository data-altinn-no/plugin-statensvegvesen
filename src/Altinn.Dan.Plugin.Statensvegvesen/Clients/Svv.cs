...
public partial class Svv
{
    public async Task<SvvResponse> Get(string ssn)
    {
        return MapToInternal(await SokKjoretoyForFodselsnummerAsync(ssn, null, null, null));
    }

    private static SvvResponse MapToInternal(KjoretoysokResponse externalResponse)
    {
